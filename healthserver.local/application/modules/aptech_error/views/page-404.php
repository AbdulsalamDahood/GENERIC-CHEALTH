...
<head>
    ...
    <title>Aptech | 404</title>
    <!-- google font -->
    <link href="http://fonts.googleapis.com/css?family=Open+Sans:400,300,600,700&amp;subset=all" rel="stylesheet" type="text/css" />
	<!-- icons -->
    <link href="fonts/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css"/>
	<link rel="stylesheet" href="<?php echo base_url();?>public/plugins/iconic/css/material-design-iconic-font.min.css">
    <!-- bootstrap -->
	<link href="<?php echo base_url();?>public/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <!-- style -->
    <link rel="stylesheet" href="<?php echo base_url();?>public/css/pages/extra_pages.css">
	<!-- favicon -->
...
<body>
			...
			<div class="wrap-login100">
				<form class="form-404">
					<span class="login100-form-logo">
						<img alt="" src="<?php echo base_url();?>public/img/logo-2.png">
					</span>
    ...
    <script src="<?php echo base_url();?>public/js/pages/extra-pages/pages.js" ></script>
    <!-- end js include path -->
</body>
