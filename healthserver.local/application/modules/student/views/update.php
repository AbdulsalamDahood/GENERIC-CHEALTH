<div class="page-content">
	<div class="page-bar">
		<div class="page-title-breadcrumb">
			<div class=" pull-left">
				<div class="page-title">Update Student Information</div>
			</div>
			<ol class="breadcrumb page-breadcrumb pull-right">
				<li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="<?php echo base_url();?>dashboard">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
				</li>
                <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="<?php echo base_url();?>student">Student</a>&nbsp;<i class="fa fa-angle-right"></i>
				</li>
		...
		<div class="col-md-12">
					...
					<div class="card-body no-padding height-9">
						<div class="row">
							<div class="profile-userpic">
								<img style="width:130px;height:130px;" src="<?php echo base_url();?>public/uploads/students/<?=$student_data->image;?>" class="img-responsive" alt=""> </div>
						</div>
						<div class="profile-usertitle">
							<div class="profile-usertitle-name"> <?=$student_data->fullname;?> </div>
							<div class="profile-usertitle-job"> <?=$student_data->course;?> </div>
						</div>
						<ul class="list-group list-group-unbordered">
							<li class="list-group-item">
								<b>E - mail  </b> <a class="pull-right"><?=$student_data->email;?></a>
							</li>
							<li class="list-group-item">
								<b>Phone  </b> <a class="pull-right"><?=$student_data->phone;?></a>
							</li>
                            <li class="list-group-item">
                                <b>Gender</b> <a class="pull-right"><?=$student_data->gender;?></a>
							</li>
                            <li class="list-group-item">
								<b>Gaurdian Name  </b> <a class="pull-right"><?=$student_data->parent_name;?></a>
							</li>
                            
                            <li class="list-group-item" style="border-bottom:none;">
								<b>Gaurdian Phone Number  </b> <a class="pull-right"><?=$student_data->parent_number;?></a>
							</li>
			...
			<div class="profile-content">
				<div class="row">
						<div class="card card-topline-aqua">
						<div class="card-head">
							<header>Update <?=$student_data->fullname;?> Information</header>	
						</div>
