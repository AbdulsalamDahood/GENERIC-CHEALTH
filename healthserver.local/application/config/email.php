...
$config['protocol']         = 'stmp';//'mail';                   // 'mail', 'sendmail', or 'smtp'
$config['mailpath']         = '/usr/sbin/sendmail';
$config['smtp_host']        = 'smtp.mailtrap.io';//'smtp.gmail.com';
$config['smtp_user']        = '5566cc783858b7';//'marioserverdevelop@gmail.com';
$config['smtp_pass']        = 'bf6a48a92983ea';//'mariogotze1997';
