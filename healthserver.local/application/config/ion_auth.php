 ...
 */
$config['site_title']                 = "Aptech";       // Site Title, example.com
$config['admin_email']                = "noreply@aptech.com"; // Admin Email, admin@example.com
$config['default_group']              = 'members';           // Default group, use name
$config['admin_group']                = 'admin';             // Default administrators group, use name
$config['identity']                   = 'email'; 			 // A database column which is used to login with
$config['alt_identity']		  = 'username';          // A Alternative database column which is used to login with
...
/*
 | -------------------------------------------------------------------------
 | Secured Session Name For The Application
 | -------------------------------------------------------------------------
 */
$config['app_session_name'] = "TBOSTK";
$config['app_session_expiry'] = time()+(86400 * 30);
